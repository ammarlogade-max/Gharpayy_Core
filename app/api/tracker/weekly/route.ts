...
const weeklySchema = z.object({
  ...
  g1: goalSchema.default({}),
  g2: goalSchema.default({}),
  g3: goalSchema.default({}),
  g4: goalSchema.default({}),
  glTours: glToursSchema.default({}),
  initial: z.string().max(2000).default(''),
  onIt: z.string().max(2000).default(''),
