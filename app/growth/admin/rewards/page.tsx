...
import {
  ...
  Loader2, ShoppingBag, X, Save, AlertCircle
} from 'lucide-react';
              ...
              <tbody className="divide-y divide-gray-100">
                ...
                {rewards.map((r) => (
                  <tr key={r._id} className="hover:bg-gray-50/60 transition">
                    ...
                    <td className="px-5 py-3 font-bold text-sm text-gray-800">{r.coinCost.toLocaleString()} 🪙</td>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
          <div className="bg-white rounded-2xl shadow-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto">
            ...
            <div className="px-6 py-5 space-y-4">
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-bold text-gray-600 mb-1">Coin Cost 🪙</label>
                  <input
                    type="number" min={0}
                    className="w-full border border-gray-200 rounded-xl px-3 py-2.5 text-sm outline-none focus:border-orange-400 transition"
